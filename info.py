...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003748566745'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003748566745'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003748566745')) 
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003726486971') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003856875320') 
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

DATABASE_URI = environ.get('DATABASE_URI', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Denim')
...
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/kdramatalkies')

AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1003726486971") # add multiple channels here, separated by single space
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1003726486971')
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/kdramatalkies")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/kdramatalkies")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/kdramatalkies")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/kdramatalkies') 
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
AUTO_DELETE_TIME = int(environ.get("AUTO_DELETE_TIME", "100"))  
